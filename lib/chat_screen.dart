...
class ChatScreen extends StatefulWidget {
  final String? carwasherId;
  final String? carwasherName;
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  bool get isCarwasher => _currentUserId == widget.carwasherId;
  ...
  void _sendMessage() {
    if (_messageController.text.trim().isNotEmpty) {
      ...
      if (isCarwasher) {
        ...
        receiverUid = widget.carownerId!;
      } else {
        senderUid = _currentUserId!;
        receiverUid = widget.carwasherId!;
      }
  ...
  Widget build(BuildContext context) {
    String? chatPartnerName = isCarwasher ? widget.carownerName : widget.carwasherName;
                    ...
                    builder: (context, AsyncSnapshot<DatabaseEvent> snapshot) {
                      ...
                      messagesMap.forEach((key, value) {
                        if ((value['sender'] == _currentUserId &&
                                value['receiver'] == widget.carwasherId) ||
                            (value['sender'] == widget.carwasherId &&
                                value['receiver'] == _currentUserId) ||
                            (value['sender'] == _currentUserId &&
                                value['receiver'] == widget.carownerId) ||
                            (value['sender'] == widget.carownerId &&
                                value['receiver'] == _currentUserId)) {
                          messagesList.add({
